...
python3 train_classifier.py --seed $seed --pretrained_model --augment_data --weight_decay=$weight_decay --batch_size=$batch_size --init_lr=$init_lr --num_epochs 50 --output_dir=/hpctmp/e0200920/$method-$weight_decay-$batch_size-$init_lr-$seed --method $method --dataset cmnist
